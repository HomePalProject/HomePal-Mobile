    ...
    <View className="mb-6 rounded-2xl border border-surface-border bg-surface-background p-4 shadow-sm dark:border-text-secondary">
      ...
      <View className="mb-4 flex-row items-center justify-between px-1">
        <View className="flex-row items-center gap-2">
          ...
          <Text className="font-cairo text-lg font-bold text-brand-primary">Latest Meal Plan</Text>
        </View>
        <Pressable
          onPress={() => {
      ...
      <View>
        {plan ? (
          <Pressable
            ...
            android_ripple={{ color: 'rgba(150, 150, 150, 0.2)' }}>
            <Text className="text-left font-cairo text-xl font-bold text-brand-primary">
              {plan.title}
            </Text>
            <Text className="mt-2 text-left font-cairo text-sm font-semibold text-text-secondary">
          ...
          <View className="rounded-xl border border-surface-border bg-surface-surface-variant p-8">
            <Text className="text-center font-cairo text-base font-semibold text-text-secondary">
              No active meal plan found for your household.
            </Text>
          </View>
        )}
      </View>
