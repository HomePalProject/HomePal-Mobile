...
export function MealPlanHistoryCard({
  ...
  return (
    <Pressable
      ...
      <Text className="pe-10 text-start font-cairo text-lg font-bold text-text-primary">
        {plan.title}
      </Text>
      ...
      {canDelete && (
        <Pressable
          ...
          className="absolute end-3 top-3 overflow-hidden rounded-full bg-status-error p-1.5"
      ...
      <View className="mt-2 flex-row flex-wrap items-center gap-2">
        <Text className="text-start font-cairo text-sm font-semibold text-text-secondary">
