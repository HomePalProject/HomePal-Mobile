    ...
    <Modal transparent={true} visible={visible} animationType="fade" onRequestClose={onCancel}>
      <View className="flex-1 items-center justify-center bg-black/50 p-6">
        <View className="w-full max-w-sm rounded-2xl bg-surface-background p-6 shadow-lg">
          <Text className="font-cairo text-lg font-bold text-text-primary">{t('deleteModal.title')}</Text>
          ...
          <View className="mt-6 flex-row justify-end gap-3">
            <Pressable
              ...
              <Text className="font-cairo text-sm font-bold text-brand-primary">{t('deleteModal.cancel')}</Text>
            </Pressable>
